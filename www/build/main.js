...
var HomePage = /** @class */ (function () {
    ...
    HomePage = __decorate([
        ...
        __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__angular_common_http__["a" /* HttpClient */]) === "function" && _b || Object])
    ], HomePage);
    return HomePage;
    var _a, _b;
}());
...
var FindMatchComponent = /** @class */ (function () {
    ...
    FindMatchComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'find-match',template:/*ion-inline-start:"/Users/wanghui/Desktop/Classes/Textbook-exchange/textbook-exchange/src/components/find-match/find-match.html"*/'<!-- Generated template for the FindMatchComponent component -->\n<ion-content>\n<button ion-button icon-only (click) = "closeModal();" class = "close-button"><ion-icon name = "close"></ion-icon></button>\n	<h1>Exchange Offer(s):</h1>\n  <ion-list>\n  <ion-grid>\n		<ion-row style = "margin-top:1rem;">\n			<ion-col>\n				Name:\n			</ion-col>\n			<ion-col>\n				Email Address:\n			</ion-col>\n			<ion-col>\n				Title:\n			</ion-col>\n			<ion-col>\n				ISBN:\n			</ion-col>\n			<ion-col>\n				Your Book\'s Title:\n			</ion-col>\n			<ion-col>\n				Your Book\'s ISBN:\n			</ion-col>\n		</ion-row>\n		<ion-row *ngFor = "let exchanger of exchangerArray">\n			<ion-col>\n				{{exchanger.name}}\n			</ion-col>\n			<ion-col>\n				 {{exchanger.email}}\n			</ion-col>\n				<ion-col>\n				 {{exchanger.need_title}}\n			</ion-col>\n				<ion-col>\n				 {{exchanger.need_ISBN}}\n			</ion-col>\n				<ion-col>\n				 {{exchanger.owned_title}}\n			</ion-col>\n				<ion-col>\n				 {{exchanger.owned_ISBN}}\n			</ion-col>\n		</ion-row>\n  </ion-grid>\n  	<h2>Selling Offer(s):</h2>\n  <ion-grid>\n		<ion-row style = "margin-top:1rem;">\n			<ion-col>\n				Name:\n			</ion-col>\n			<ion-col>\n				Email Address:\n			</ion-col>\n			<ion-col>\n				Title:\n			</ion-col>\n			<ion-col>\n				ISBN:\n			</ion-col>\n			<ion-col>\n				Price Offered:\n			</ion-col>\n		</ion-row>\n		<ion-row *ngFor = "let seller of sellerArray">\n			<ion-col>\n				{{seller.name}}\n			</ion-col>\n			<ion-col>\n				{{seller.email}}\n			</ion-col>\n			<ion-col>\n				{{seller.need_title}}\n			</ion-col>\n			<ion-col>\n				{{seller.need_ISBN}}\n			</ion-col>\n			<ion-col>\n				{{seller.price}}\n			</ion-col>\n		</ion-row>\n  </ion-grid>\n   	<h3>Buying Offer(s):</h3>\n  <ion-grid>\n		<ion-row style = "margin-top:1rem;">\n			<ion-col>\n				Name:\n			</ion-col>\n			<ion-col>\n				Email Address:\n			</ion-col>\n			<ion-col>\n				Title:\n			</ion-col>\n			<ion-col>\n				ISBN:\n			</ion-col>\n			<ion-col>\n				Price Offered:\n			</ion-col>\n		</ion-row>\n		<ion-row *ngFor = "let buyer of buyerArray">\n			<ion-col>\n				{{buyer.name}}\n			</ion-col>\n			<ion-col>\n				{{buyer.email}}\n			</ion-col>\n			<ion-col>\n				{{buyer.owned_title}}\n			</ion-col>\n			<ion-col>\n				{{buyer.owned_ISBN}}\n			</ion-col>\n			<ion-col>\n				{{buyer.price}}\n			</ion-col>\n		</ion-row>\n  </ion-grid>\n</ion-list>\n</ion-content>\n'/*ion-inline-end:"/Users/wanghui/Desktop/Classes/Textbook-exchange/textbook-exchange/src/components/find-match/find-match.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["k" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["o" /* ViewController */],
